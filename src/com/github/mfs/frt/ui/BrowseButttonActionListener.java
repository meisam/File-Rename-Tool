...
/**
 * {@link ActionListener} for <code>browseButton</code>
 * 
 * @author Meisam Fathi
 * @version 0.1, Agust 03, 2010
 */
public class BrowseButttonActionListener implements ActionListener {

  private final IApplicationUI ui;

  public BrowseButttonActionListener(final IApplicationUI uiModel) {
    this.ui = uiModel;
  }

  @Override
  public void actionPerformed(final ActionEvent e) {
    this.ui.showFileChooser();
  }
